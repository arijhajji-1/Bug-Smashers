 ...
 */
final class Version20220222005028 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD location_id INT DEFAULT NULL, DROP location');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD location VARCHAR(255) NOT NULL, DROP location_id');
    }
}
