 ...
 */
final class Version20220220214020 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reparation ADD category_id INT NOT NULL, CHANGE reserver reserver DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reparation DROP category_id, CHANGE reserver reserver DATETIME NOT NULL');
    }
}
