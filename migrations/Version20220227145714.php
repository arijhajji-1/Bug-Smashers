 ...
 */
final class Version20220227145714 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commentaire (id INT AUTO_INCREMENT NOT NULL, users_id INT DEFAULT NULL, publications_id INT DEFAULT NULL, text VARCHAR(255) NOT NULL, datecommentaire DATETIME DEFAULT NULL, INDEX IDX_67F068BC67B3B43D (users_id), INDEX IDX_67F068BCAFFB3979 (publications_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE publication (id INT AUTO_INCREMENT NOT NULL, user INT DEFAULT NULL, titre VARCHAR(255) NOT NULL, desription VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT NULL, INDEX IDX_AF3C67798D93D649 (user), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE user CHANGE roles roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', CHANGE photo photo VARCHAR(500) DEFAULT NULL');
    }
